...
/**
 * This is the main entry point and configuration for the Team/Player
...
public class TeamPlayerApp {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("The Team/Player API allows you to perform CRUD operations on the Team and Player resources.")
